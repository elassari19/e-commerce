...
const page = async () => {
  ...
  return (
    <>
      <h1 className="font-semibold text-lg md:text-2xl pl-2 ml-2 md:ml-8 pt-4 pb-8">
        All Categories
      </h1>
      ...
      <div className='grid grid-cols-12 gap-4 my-8 mx-1 md:mx-4'>
        {
          categories.map((category) => (
            <div key={category.id} className='col-span-6 md:col-span-4 lg:col-span-3 xl:col-span-2 shadow-lg rounded-xl py-8 hover:shadow-primary'>
